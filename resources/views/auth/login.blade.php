...
<body class="bg-gradient-to-br from-blue-500 to-purple-600 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-bold text-white mb-2">KPI Dashboard</h1>
            <p class="text-blue-100">Sistema de Gestión Industrial</p>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="admin@ecoplast.com">
                    @error('email')
                ...
                <button 
                    type="submit" 
                    class="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 rounded-lg transition transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-lg">
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <div class="bg-blue-50 rounded-lg p-4">
                    ...
                    <div class="text-xs text-gray-700 space-y-1">
                        <p><span class="font-semibold">Email:</span> admin@ecoplast.com</p>
                        <p><span class="font-semibold">Contraseña:</span> 123456</p>
                        <p class="text-blue-600 mt-2">Rol: SuperAdmin (Acceso Total)</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-6 text-white text-sm">
            <p>&copy; 2025 Metalúrgica Precision S.A. - KPI Dashboard</p>
        </div>
    </div>
</body>
</html>
