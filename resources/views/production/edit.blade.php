...
<head>
    ...
    <title>Editar Producción - Metalúrgica Precision S.A.</title>
            ...
            <div class="container mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-gray-600">Editar Registro de Producción</p>
                    </div>
        ...
        <main class="container mx-auto px-6 py-8">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-lg shadow-md p-8">
                    <div class="mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">Editar Registro de Producción</h2>
                        <p class="text-gray-600 mt-1">Actualice los datos de producción del equipo</p>
                    </div>

                    <form action="{{ route('production.update', $production) }}" method="POST" id="productionForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                >
                                    ...
                                    @foreach($equipment as $eq)
                                        <option value="{{ $eq->id }}" {{ old('equipment_id', $production->equipment_id) == $eq->id ? 'selected' : '' }}>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('production_date', $production->production_date->format('Y-m-d\TH:i')) }}"
                                    required
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('planned_production', $production->planned_production) }}"
                                    required
                                    min="1"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('actual_production', $production->actual_production) }}"
                                    required
                                    min="0"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="good_units"
                                    name="good_units"
                                    value="{{ old('good_units', $production->good_units) }}"
                                    required
                                    min="0"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('defective_units', $production->defective_units) }}"
                                    required
                                    min="0"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input
                                    ...
                                    id="cycle_time"
                                    name="cycle_time"
                                    value="{{ old('cycle_time', $production->cycle_time) }}"
                                    required
                                    min="0.1"
